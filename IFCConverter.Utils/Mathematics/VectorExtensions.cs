...
namespace IFCConverter.Utils.Mathematics
{
    public static class VectorExtensions
    {
        ...
        ///     tolerance, it indicates that the vectors are parallel. This is a common technique in vector mathematics to
        ///     determine
        ...
        {
            return first.IsParallel(second, tolerance) && first.Normalize(2).DotProduct(second.Normalize(2)) > -tolerance;
        }

...
namespace IFCConverter.Importers
{
    internal interface IImporter
    {
        ...
        /// </summary>
        /// <param name="products">An array of <see cref="IfcProduct"/> objects to extract pipe segments from.</param>
        ...
        /// </summary>
        /// <param name="products">An array of <see cref="IfcProduct"/> objects to extract bends from.</param>
        ...
        /// </summary>
        /// <param name="products">An array of <see cref="IfcProduct"/> objects to extract tees from.</param>
        ...
        /// </summary>
        /// <param name="products">An array of <see cref="IfcProduct"/> objects to extract anchors from.</param>
        ...
        /// Retrieves an array of IfcElement objects representing anchors from the provided IfcProduct array.
        /// </summary>
        /// <param name="products">An array of <see cref="IfcProduct"/> objects to extract valves from.</param>
        /// <returns>An array of IfcProduct objects representing valves.</returns>
        ...
        /// </summary>
        /// <param name="pipes">An array of <see cref="IfcElement"/> objects to convert into entities.</param>
        ...
        /// </summary>
        /// <param name="bends">An array of <see cref="IfcElement"/> objects representing bends.</param>
        ...
        /// </summary>
        /// <param name="tees">An array of <see cref="IfcElement"/> objects representing tees.</param>
        ...
        /// Creates an array of IfcWeldedTeeEntity objects from the provided tees and abstract segment entities.
        /// </summary>
        /// <param name="reducers">An array of <see cref="IfcElement"/> objects representing reducers.</param>
        ...
        /// Creates an array of IfcWeldedTeeEntity objects from the provided tees and abstract segment entities.
        /// </summary>
        /// <param name="anchors">An array of <see cref="IfcElement"/> objects representing anchors.</param>
        /// <param name="abstractSegmentEntities">An array of IfcAbstractSegmentEntity objects to associate with the reducers.</param>
        ...
        /// Creates an array of IfcWeldedTeeEntity objects from the provided tees and abstract segment entities.
        /// </summary>
        /// <param name="valves">An array of <see cref="IfcElement"/> objects representing valves.</param>
        /// <param name="abstractSegmentEntities">An array of IfcAbstractSegmentEntity objects to associate with the reducers.</param>
        /// <returns>An array of <see cref="IfcAbstractAnchorEntity"/> objects.</returns>

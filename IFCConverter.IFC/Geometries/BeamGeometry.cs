...
namespace IFCConverter.IFC.Geometries
{
    ...
    public class BeamGeometry : IfcGeometry
    {
        ...
        private static Vector<double>[] GenerateStartPoints(BeamGeometryProperties properties, Vector<double> xHeight, Vector<double> yWidth)
        {
            ...
            {
                case BendGeometryType.IBEAM:
                    return GenerateIBeamStartPoints(properties, xHeight, yWidth);
                case BendGeometryType.CHANNEL:
                    return GenerateChannelBeamStartPoints(properties, xHeight, yWidth);
                case BendGeometryType.TBEAM:
                    return GenerateTBeamStartPoints(properties, xHeight, yWidth);
                case BendGeometryType.CORNERBEAM:
                    return GenerateCornerBeamStartPoints(properties, xHeight, yWidth);
                case BendGeometryType.CIRCLEBEAM:
                    return GenerateCircleBeamStartPoints(properties, xHeight, yWidth);
                case BendGeometryType.RECTANGULARBEAM:
                    return GenerateRectangularBeamStartPoints(properties, xHeight, yWidth);
                default:

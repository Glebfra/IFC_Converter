...
public class IfcFabricatedTeeEntity : IfcAbstractEntity
{
    private readonly StartFabricatedTeeEntity _teeEntity;
    ...
    public override IfcProduct CreateAndAdd(IModel model)
    {
        ...
        teeExtrudedArea[i++] = CreateTeeBranchShape(model, headPipe, _teeEntity.GetBranchHeight() + branchPipes[0].Diameter / 2);

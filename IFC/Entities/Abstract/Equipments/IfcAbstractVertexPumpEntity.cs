...
namespace IFC.Entities.Abstract.Equipments
{
    ...
    public abstract class IfcAbstractVertexPumpEntity : IfcAbstractEquipmentEntity
    {
        ...
        private readonly StartPumpEntity _pumpEntity;
        private IfcPump? _pump;
        
        protected IfcAbstractVertexPumpEntity(StartPumpEntity pumpEntity, IfcNodeEntity nodeEntity, IfcAbstractSegmentEntity[] segmentEntities) 

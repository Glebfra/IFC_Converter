...
{
    /// <summary>
    /// Represents an abstract rigid element entity in the IFC model.
    /// </summary>
    public abstract class IfcAbstractRigidElementEntity : IfcAbstractSegmentEntity
    {
        /// <summary>
        /// Gets the color of the rigid element entity.
        /// </summary>
        public override ActionProperty<Colour> Colour { get; } = Tools.Colour.FromHEX("009249");
        
        /// <summary>
        /// Initializes a new instance of the <see cref="IfcAbstractRigidElementEntity"/> class with the specified matrix, length, and diameter.
        /// </summary>
        /// <param name="matrix3D">The transformation matrix of the rigid element.</param>
        /// <param name="length">The length of the rigid element.</param>
        /// <param name="diameter">The diameter of the rigid element.</param>
        protected IfcAbstractRigidElementEntity(XbimMatrix3D matrix3D, double length, double diameter) : base(matrix3D, length, diameter) { }

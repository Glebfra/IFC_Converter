...
namespace IFC.Entities.Abstract.Fittings
{
    public abstract class IfcAbstractVertexReducerEccentricEntity : IfcAbstractReducerEntity
    {
        ...
        public override IfcProduct CreateAndAdd(IModel model)
        {
            ...
            double[] radiuses = AbstractSegmentEntities.Select(item => item.Diameter / 2).ToArray();
            ...
            IfcFacetedBrep facetedBrep = IfcVertexGeometry.CreateClippedCone(model, radiuses[0], radiuses[1], Length, NumSegments, axisSettings, displacement);

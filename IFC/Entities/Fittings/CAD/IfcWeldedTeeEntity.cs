...
namespace IFC.Entities.Fittings.CAD
{
    ...
    public class IfcWeldedTeeEntity : IfcAbstractTeeEntity
    {
        ...
        public IfcWeldedTeeEntity(IfcLabel name, IfcIdentifier tag, XbimMatrix3D objectMatrix3D, double length, double branchDiameter, double headDiameter, double height, double angle) 
            : base(objectMatrix3D)
        {
            Name = name;
            Tag = tag;

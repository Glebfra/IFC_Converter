...
namespace IFC.Entities.Fittings.CAD
{
    ...
    public sealed class IfcFabricatedTeeEntity : IfcAbstractTeeEntity
    {
        ...
        public IfcFabricatedTeeEntity(StartTeeEntity teeEntity, IfcNodeEntity nodeEntity, IfcAbstractSegmentEntity[] segmentEntities) : base(teeEntity, nodeEntity, segmentEntities)
        {
            ...
            Height = teeEntity.BranchHeight.SIProperty + _BranchPipes[0].Diameter / 2;
        }
    }

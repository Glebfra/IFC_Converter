...
namespace IFC.Entities.Fittings.CAD
{
    ...
    public class IfcWeldoletEntity : IfcAbstractTeeEntity
    {
        ...
        public IfcWeldoletEntity(IfcLabel name, IfcIdentifier tag, XbimMatrix3D objectMatrix3D, double length, double branchDiameter, double headDiameter, double height, double angle) 
            : base(objectMatrix3D)
        {
            Name = name;
            Tag = tag;
    ...
    public sealed class IfcWeldoletEntity : IfcAbstractTeeEntity
    {
        ...
        public IfcWeldoletEntity(StartTeeEntity teeEntity, IfcNodeEntity nodeEntity, IfcAbstractSegmentEntity[] segmentEntities) 

...
namespace IFC.Entities.Fittings.CAD
{
    ...
    public class IfcStandTeeEntity : IfcAbstractTeeEntity
    {
        ...
        public IfcStandTeeEntity(IfcLabel name, IfcIdentifier tag, XbimMatrix3D objectMatrix3D, double length, double branchDiameter, double headDiameter, double height, double angle) 
            : base(objectMatrix3D)
        {
            Name = name;
            Tag = tag;
    ...
    public sealed class IfcStandTeeEntity : IfcAbstractTeeEntity
    {
        public override double Length { get; protected set; }
        public override double Height { get; protected set; }
        public override double Angle { get; protected set; }
        
        public IfcStandTeeEntity(StartTeeEntity teeEntity, IfcNodeEntity nodeEntity, IfcAbstractSegmentEntity[] segmentEntities) : base(teeEntity, nodeEntity, segmentEntities)
        {

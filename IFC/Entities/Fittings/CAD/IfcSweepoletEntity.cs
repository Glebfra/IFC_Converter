...
namespace IFC.Entities.Fittings.CAD
{
    ...
    public sealed class IfcSweepoletEntity : IfcAbstractTeeEntity
    {
        ...
        public IfcSweepoletEntity(IfcLabel name, IfcIdentifier tag, XbimMatrix3D objectMatrix3D, double length, double branchDiameter, double headDiameter, double height, double angle) 
            : base(objectMatrix3D)
        {
            Name = name;
            Tag = tag;

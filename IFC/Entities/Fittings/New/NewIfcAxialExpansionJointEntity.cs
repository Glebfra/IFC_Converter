...
{
    public class NewIfcAxialExpansionJointEntity : NewIfcAbstractAxialExpansionJointEntity
    {
        ...
        public NewIfcAxialExpansionJointEntity(IfcLabel name, IfcIdentifier tag, XbimMatrix3D objectMatrix3D, double length, double diameter, int numSegments)
        {

...
namespace IFC.Entities.Anchors
{
    ...
    public class IfcSpringHangerEntity : IfcAbstractSpringHangerEntity
    {
        ...
        public IfcSpringHangerEntity(IfcLabel name, IfcIdentifier tag, XbimMatrix3D objectMatrix, double diameter, double height, int numSegments) 
            : base(objectMatrix)
        {
            Name = name;
            Tag = tag;

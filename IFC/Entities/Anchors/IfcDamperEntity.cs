...
namespace IFC.Entities.Anchors
{
    public class IfcDamperEntity : IfcAbstractDamperEntity
    {
        ...
        public IfcDamperEntity(IfcLabel name, IfcIdentifier tag, XbimMatrix3D objectMatrix, StartDamperEntity damper, double diameter, double height, int numSegments) 
            : base(objectMatrix)
        {
            Name = name;
            Tag = tag;
            NonStandardRestraint = damper;
            Diameter = diameter;
            Height = height;

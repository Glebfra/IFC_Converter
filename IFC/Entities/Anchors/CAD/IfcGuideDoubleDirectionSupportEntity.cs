...
{
    public class IfcGuideDoubleDirectionSupportEntity : IfcAbstractAnchorEntity
    {
        private int _numSegments;
        private double _height;
        
        private StartGuideDoubleDirectionSupportEntity _doubleDirectionSupportEntity;
        ...
        {
            _doubleDirectionSupportEntity = doubleDirectionSupportEntity;
        ...
        public override IfcProduct CreateAndAdd(IModel model)
        {
            ...
            {
                accessory.Name = _doubleDirectionSupportEntity.Name;
                accessory.Tag = Tag;

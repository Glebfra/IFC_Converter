...
namespace IFC.Entities.Anchors
{
    ...
    public class IfcConstantForceSupportEntity : IfcAbstractConstantForceSupportEntity
    {
        ...
        public IfcConstantForceSupportEntity(IfcLabel name, IfcIdentifier tag, XbimMatrix3D objectMatrix, double diameter, double height, int numSegments) 
            : base(objectMatrix)
        {
            Name = name;
            Tag = tag;
    ...
    public sealed class IfcConstantForceSupportEntity : IfcAbstractConstantForceSupportEntity
    {

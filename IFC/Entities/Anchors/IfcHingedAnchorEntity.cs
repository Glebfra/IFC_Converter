...
{
    public class IfcHingedAnchorEntity : IfcAbstractHingedAnchorEntity
    {
        ...
        public IfcHingedAnchorEntity(IfcLabel name, IfcIdentifier tag, XbimMatrix3D objectMatrix, double diameter, double height, int numSegments) 
            : base(objectMatrix)
        {
            Name = name;
            Tag = tag;

...
{
    public class IfcHingedAnchorEntity : IfcAbstractAnchorEntity
    {
        ...
        public IfcHingedAnchorEntity(StartHingedAnchorEntity hingedAnchorEntity, IfcNodeEntity nodeEntity, IfcAbstractSegmentEntity[] abstractSegmentEntities, int numSegments) 
            : base(hingedAnchorEntity, nodeEntity, abstractSegmentEntities)
        {
            _hingedAnchorEntity = hingedAnchorEntity;

            _isVertical = _IfcAbstractSegmentEntities[0].ObjectMatrix3D.Forward == VectorExtensions.Z;

            _numSegments = numSegments;
            _angleStep = 2 * Math.PI / _numSegments;
            
            _coneRadius = _IfcAbstractSegmentEntities[0].Diameter / 2;
            _xDim = _coneRadius * 3;
            _yDim = _xDim;

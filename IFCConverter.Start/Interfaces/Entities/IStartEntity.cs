...
{
    /// <summary>
    ///     Defines the base contract for all domain entities within the IFCConverter.Start system.
    /// </summary>
    /// <remarks>
    ///     <para>
    ///         Every entity in the IFCConverter.Start domain model must implement this interface.
    ///         It provides:
    ///     </para>
    ///     <list type="bullet">
    ///         <item>
    ...
    public interface IStartEntity
    {
        ...
        ///     </para>
        /// </remarks>
        List<IStartEntity> ConnectedEntities { get; set; }

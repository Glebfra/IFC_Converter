...
namespace IFCConverter.Start.Interfaces
{
    public interface IStartBaseRootDataArray : IDisposable
    {
        ...
        object AddElement(StartElementTypeEnum type, out int index);
        ...
        /// <param name="index">The index of the added element.</param>
        /// <returns>The added element.</returns>
        object AddElementAndNode(StartElementTypeEnum type, int nSNode, int nENode, out int index);
        ...
        /// <param name="index">The index of the added element.</param>
        /// <returns>The added element.</returns>
        object AddElementAndNode(StartElementTypeEnum type, int nSNode, out int index);
        ...
        void SetDataBlockJson(int mode, string json);
        ...
        IStartBaseRoot GetElementDispatch(int id, StartElementTypeEnum minType, StartElementTypeEnum maxType);
        ...
        IStartBaseRoot GetConnDispatch(int id, int nNumber);
        ...
        int GetNumberElements(StartElementTypeEnum minType = StartElementTypeEnum.ALL,
        ...
        int GetNumberConns(int id, StartElementTypeEnum minType, StartElementTypeEnum maxType);
        ...
        string GetDataJson(StartElementTypeEnum minType, StartElementTypeEnum maxType, int mode = 0);
    }
}
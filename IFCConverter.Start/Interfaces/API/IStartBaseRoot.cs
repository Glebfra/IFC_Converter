...
namespace IFCConverter.Start.Interfaces
{
    public interface IStartBaseRoot : IDisposable
    {
        ...
        IStartBaseRoot GetConnElemOnType(StartElementTypeEnum type, int nNumber);
        ...
        string GetDataJson(int mode = 0, int key = 0);
        ...
        void SetDataJson(int key, string data);
    }
}
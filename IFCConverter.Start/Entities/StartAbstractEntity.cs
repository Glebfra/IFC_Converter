...
namespace IFCConverter.Start.Entities
{
    ...
    public abstract class StartAbstractEntity : IStartEntity
    {
        ...
        ///     This property is ignored during JSON serialization and by the IFCConverter.Start framework.
        /// </summary>
        [JsonIgnore]
        [StartIgnore]
        ...
        private static void AddToDictionary(IDictionary<string, string> dictionary, Type type, object obj, string propertyName = null)
        {

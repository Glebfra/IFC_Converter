...
public struct StartTeeEntityProperties
{
    ...
    [JsonProperty("9")] public double HeaderThickness { get; set; }
    [JsonProperty("13")] public double MillTolerance { get; set; }
    [JsonProperty("16")] public double HeaderLength { get; set; }
    [JsonProperty("18")] public double BranchWallThickness { get; set; }
    [JsonProperty("20")] public double MillToleranceForBranch { get; set; }
    [JsonProperty("21")] public double BranchHeight { get; set; }
    [JsonProperty("22")] public double PadThickness { get; set; }
    [JsonProperty("23")] public double PadWidth { get; set; }
    [JsonProperty("24")] public double CrotchHeight { get; set; }
    [JsonProperty("25")] public double CrotchThickness { get; set; }
    [JsonProperty("34")] public double Weight { get; set; }
    [JsonProperty("38")] public double StrengthFactorOfLongitudinalWeldSeamOnPressure { get; set; }
    [JsonProperty("174")] public double CrotchRadius { get; set; }

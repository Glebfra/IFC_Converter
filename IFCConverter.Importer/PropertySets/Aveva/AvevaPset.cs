...
namespace IFCConverter.Importer.PropertySets.Aveva
{
    ...
    internal class AvevaPset : AbstractPropertySet
    {
        ...
        [Property("ASFBR", converter: typeof(AvevaDoublePropertyConverter))] public bool Asfbr = default;
        [Property("BRANCH")] public string Branch = string.Empty;
        [Property("BUIL", converter: typeof(AvevaDoublePropertyConverter))] public bool Buil = default;
        [Property("CSFBR", converter: typeof(AvevaDoublePropertyConverter))] public bool Csfbr = default;
        [Property("DELDSG", converter: typeof(AvevaDoublePropertyConverter))] public bool Deldsg = default;
        [Property("DPGRID")] public int Dpgrid = default;
        [Property("HREL", converter: typeof(AvevaDoublePropertyConverter))] public bool Hrel = default;
        [Property("ISOH", converter: typeof(AvevaDoublePropertyConverter))] public bool Isoh = default;
        ...
        [Property("LOCK", converter: typeof(AvevaDoublePropertyConverter))] public bool Lock = default;
        [Property("LOOS", converter: typeof(AvevaDoublePropertyConverter))] public bool Loos = default;
        [Property("LSFBR", converter: typeof(AvevaDoublePropertyConverter))] public bool Lsfbr = default;
        ...
        [Property("ORIL", converter: typeof(AvevaDoublePropertyConverter))] public bool Oril = default;
        ...
        [Property("POSI", converter: typeof(AvevaDoublePropertyConverter))] public bool Posi = default;
        [Property("PTNO")] public int Ptno = default;
        [Property("PTNT")] public int Ptnt = default;
        [Property("RLOC")] public int Rloc = default;
        [Property("SHOP", converter: typeof(AvevaDoublePropertyConverter))] public bool Shop = default;
        [Property("SITE")] public string Site = string.Empty;
        [Property("SPRE")] public string Spre = string.Empty;
        [Property("TSFBR", converter: typeof(AvevaDoublePropertyConverter))] public bool Tsfbr = default;

...
namespace IFCConverter.Importer.PropertySets.Aveva
{
    ...
    internal class AvevaPset : AbstractPropertySet
    {
        ...
        [Property("ASFBR", converter: typeof(AvevaBoolPropertyConverter))]
        public bool Asfbr = default;

        [Property("BRANCH")] public string Branch = string.Empty;

        [Property("BUIL", converter: typeof(AvevaBoolPropertyConverter))]
        public bool Buil = default;

        [Property("CSFBR", converter: typeof(AvevaBoolPropertyConverter))]
        public bool Csfbr = default;

        [Property("DELDSG", converter: typeof(AvevaBoolPropertyConverter))]
        public bool Deldsg = default;

        [Property("DPGRID")] public int Dpgrid = default;

        [Property("HREL", converter: typeof(AvevaBoolPropertyConverter))]
        public bool Hrel = default;

        [Property("ISOH", converter: typeof(AvevaBoolPropertyConverter))]
        public bool Isoh = default;
        ...
        [Property("LOCK", converter: typeof(AvevaBoolPropertyConverter))]
        public bool Lock = default;

        [Property("LOOS", converter: typeof(AvevaBoolPropertyConverter))]
        public bool Loos = default;

        [Property("LSFBR", converter: typeof(AvevaBoolPropertyConverter))]
        public bool Lsfbr = default;
        ...
        [Property("SHOP", converter: typeof(AvevaBoolPropertyConverter))]
        public bool Shop = default;

        [Property("SITE")] public string Site = string.Empty;
        [Property("SPRE")] public string Spre = string.Empty;

        [Property("TSFBR", converter: typeof(AvevaBoolPropertyConverter))]
        public bool Tsfbr = default;

...
{
    [TopologyEntity]
    internal sealed class FiltTopologyEntity : TopologyEntity, ISegmentTopologyEntity
    {
        public FiltTopologyEntity(IBoundaryProxy proxy, IReadOnlyCollection<ITopologyNodeEntity> nodes) 
            : base(proxy, nodes)
        {

...
{
    internal sealed class TorsionExpansionJointDomainEntityExporter : AbstractJointDomainEntityExporter
    {
        ...
        override protected IIfcGeometry CreateGeometry(Joint joint, IModel model)
        {
            ...
            return TorsionExpansionJointGeometry.CreateGeometry(model, new TorsionExpansionJointGeometryProperties()
            {

...
{
    internal sealed class SegmentedExpansionJointDomainEntityExporter : IJointDomainEntityExporter
    {
        ...
        public void Export(Joint joint, IModel model, ExportContext context)
        {
            ...
            IIfcGeometry geometry = SegmentedExpansionJointGeometry.CreateGeometry(model, new SegmentedExpansionJointGeometryProperties()
            {

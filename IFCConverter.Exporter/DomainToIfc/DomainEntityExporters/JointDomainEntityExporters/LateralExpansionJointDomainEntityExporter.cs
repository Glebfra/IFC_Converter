...
{
    internal sealed class LateralExpansionJointDomainEntityExporter : IJointDomainEntityExporter
    {
        ...
        public void Export(Joint joint, IModel model, ExportContext context)
        {
            ...
            IIfcGeometry geometry = LateralExpansionJointGeometry.CreateGeometry(model, new LateralExpansionJointGeometryProperties()
            {
                Diameter = diameter,
